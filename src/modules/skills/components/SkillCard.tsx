  ...
  if (width === 'sm' || width === 'md')
    return (
      <div
        ...
        <div className="w-fit text-lighter bg-darker/80 rounded-sm py-2 px-2 text-lighter text-xl font-medium font-body mb-10 flex justify-center backdrop-blur-md text-center">
          {data.name}
        </div>
      </div>
    )
